    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalTable: "AspNetUsers",
                        principalColumn: "LarchCustomerId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.AddColumn<int>(
                name: "LarchCustomerId",
                table: "AspNetUsers",
                nullable: false,
                defaultValue: 0);
            migrationBuilder.AddUniqueConstraint(
                name: "AK_ApplicationUser_LarchCustomerId",
                table: "AspNetUsers",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_IdentityUserRole<string>_IdentityRole_RoleId", table: "AspNetUserRoles");
            migrationBuilder.DropForeignKey(name: "FK_IdentityUserRole<string>_ApplicationUser_UserId", table: "AspNetUserRoles");
            migrationBuilder.DropUniqueConstraint(name: "AK_ApplicationUser_LarchCustomerId", table: "AspNetUsers");
            migrationBuilder.DropColumn(name: "LarchCustomerId", table: "AspNetUsers");
